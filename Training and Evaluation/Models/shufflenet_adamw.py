...
train_dataloader = DataLoader(TrainDataset(train_set, class_map), batch_size=128, shuffle=True)
...
model.conv1[0] = nn.Conv2d(1, 24, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1))
...
# Save model
torch.save(model.state_dict(), 'shufflenet_adamW.pth')
